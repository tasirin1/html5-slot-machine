...
(() => {
  ...
  (() => {
    ...
    function p(t, e) {
      ...
      for (var n, r = [], i = 0; i < f.length; i++) {
        ...
        if (
          !(
            v <
            ((n = c), "CHERRY" === n || "LEMON" === n || "ORANGE" === n ? 2 : 3)
          )
        ) {
          var b = h(c, v);
          b <= 0 ||
    ...
    function g() {
      ...
      try {
        for (n.s(); !(t = n.n()).done; )
          for (var r = t.value, i = v[r], o = 0; o < i.weight; o++)
            e.push(i.id);
      } catch (t) {
        n.e(t);
      } finally {
              ...
              try {
                for (n.s(); !(e = n.n()).done; ) {
                  ...
                  if (a) {
                    ...
                    if (l) {
                      var u = l.querySelectorAll(".sym")[o];
                      u && u.classList.add("highlight");
                    }
                  }
                }
              } catch (t) {
                ...
                var r = performance.now(),
                  ...
                  o = function (a) {
                    var l = Math.min((a - r) / n, 1),
                      u = 1 - Math.pow(1 - l, 3),
                      s = Math.floor(i + (e - i) * u);
                    (t.textContent = s.toLocaleString("id-ID")),
    ...
    function B() {
      ...
      function c(t, e, n, r) {
        var o = e && e.prototype instanceof m ? e : m,
          ...
          l = new F(r || []);
        return i(a, "_invoke", { value: k(t, n, l) }), a;
      }
      function f(t, e, n) {
        try {
      ...
      function k(e, n, r) {
        ...
        return function (o, a) {
          ...
          for (r.method = o, r.arg = a; ; ) {
            ...
            var s = f(e, n, r);
            if ("normal" === s.type) {
              if (((i = r.done ? d : p), s.arg === v)) continue;
              ...
              for (;;)
                switch ((e.prev = e.next)) {
                  case 0:
                    return e.abrupt(
                      "return",
                      P("/api/money", { balance: Math.floor(t) }),
                    );
                  case 1:
                  case "end":
                    return e.stop();
                            ...
                            if (
                              ...
                              this.anim.highlightWins(S),
                                ...
                                this.el.spinBtn &&
                                  ...
                                  this.anim.burst(O.left + O.width / 2, O.top));
              ...
              if (Math.random() < t) {
                ...
                if (e && 1 !== e) {
                  ...
                  try {
                    for (l.s(); !(a = l.n()).done; ) {
                      var u = a.value;
                      u.amount = Math.floor(u.amount * e);
                    }
                  } catch (t) {
                    l.e(t);
                  } finally {
