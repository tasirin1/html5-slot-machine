/*! For license information please see bundle.08714443972ca5111788.js.LICENSE.txt */
(() => {
  "use strict";
  (() => {
    function t(e) {
      ...
      o = (function () {
        function t() {
          ...
          !(function (t, e) {
            ...
            (this.name = e),
            r[e]
              ? (this.img = r[e].cloneNode(!0))
              : ((this.img = t.createImage(e)), (r[e] = this.img));
        }
        return (
          (n = t),
          (o = [
            {
              ...
              value: function (e) {
                ...
                (n.className = "sym " + e),
                  (n.style.cssText =
                    "width:100%;aspect-ratio:1;display:flex;align-items:center;justify-content:center;font-size:clamp(28px,5vw,52px);font-weight:bold;border-radius:8px;margin:2px 0;user-select:none;");
                var r = t.DATA[e] || t.DATA.seven;
                return (
                  (n.style.background = r.bg),
                  (n.style.color = r.color),
                  (n.style.textShadow = r.shadow || "none"),
                  (n.style.border =
                    r.border || "2px solid rgba(255,255,255,0.1)"),
                  (n.textContent = r.icon),
                  n
                );
              },
            },
    ...
    function l() {
      ...
      function P(e, n, r) {
        ...
        return function (i, a) {
          ...
          for (r.method = i, r.arg = a; ; ) {
            ...
            var u = p(e, n, r);
            if ("normal" === u.type) {
              if (((o = r.done ? g : d), u.arg === v)) continue;
              return { value: u.arg, done: r.done };
            }
            "throw" === u.type &&
              ((o = g), (r.method = "throw"), (r.arg = u.arg));
          }
        };
      }
      function O(e, n) {
      ...
      return (
        ...
        (w.displayName = h(x, c, "GeneratorFunction")),
        ...
        (e.mark = function (t) {
          return (
            Object.setPrototypeOf
              ...
              : ((t.__proto__ = x), h(t, c, "GeneratorFunction")),
        ...
        C(j.prototype),
        h(j.prototype, s, function () {
          return this;
        }),
        (e.AsyncIterator = j),
        (e.async = function (t, n, r, o, i) {
          void 0 === i && (i = Promise);
          var a = new j(f(t, n, r, o), i);
                  ...
                  switch ((n.prev = n.next)) {
                    case 0:
                      return (
                        (n.prev = 0),
                        (n.next = 3),
                        fetch("".concat(p, "/api/login"), {
                          method: "POST",
                          headers: { "Content-Type": "application/json" },
                          body: JSON.stringify({ username: t, pin: e }),
                        })
                      );
                    case 3:
    ...
    function b() {
      ...
      var S = Object.getPrototypeOf,
        L = S && S(S(_([])));
      L && L !== n && r.call(L, a) && (E = L);
      var k = (x.prototype = g.prototype = Object.create(E));
      function C(t) {
        ["next", "throw", "return"].forEach(function (e) {
          u(t, e, function (t) {
            return this._invoke(e, t);
        ...
        return function (i, a) {
          ...
          for (r.method = i, r.arg = a; ; ) {
            ...
            if ("next" === r.method) r.sent = r._sent = r.arg;
              ...
              if (o === f) throw ((o = d), r.arg);
              r.dispatchException(r.arg);
            } else "return" === r.method && r.abrupt("return", r.arg);
            o = y;
            var u = h(e, n, r);
            if ("normal" === u.type) {
              if (((o = r.done ? d : p), u.arg === m)) continue;
              return { value: u.arg, done: r.done };
            }
            "throw" === u.type &&
              ((o = d), (r.method = "throw"), (r.arg = u.arg));
          }
        };
      }
      function O(e, n) {
      ...
      return (
        (t = function t() {
          ...
          !(function (t, e) {
            ...
            this.loginPin.addEventListener("keydown", function (t) {
        ...
        (e = [
                    ...
                    function (t) {
                      for (;;)
                        switch ((t.prev = t.next)) {
                          case 0:
                            if (
                              ((e = this.loginUser.value.trim()),
                              (n = this.loginPin.value.trim()),
                              e && n)
                            ) {
                              t.next = 5;
                              break;
                          ...
                          case 10:
                            ...
                            return (
                              ...
                              (this.loginBtn.disabled = !1),
                              (this.loginBtn.textContent = "PLAY"),
                              t.abrupt("return")
                            );
                          case 16:
                            (o = r.account),
                              (this.gameConfig = r.config || {
                                winRate: 0.15,
                                payoutMultiplier: 3,
          ...
          },
          {
            ...
            value: function () {
              this.moneyDisplay &&
                (this.moneyDisplay.textContent = g(this.money)),
                this.betDisplay && (this.betDisplay.textContent = g(this.bet)),
                this.jackpotDisplay &&
                  this.gameConfig &&
                  (this.jackpotDisplay.textContent =
                    this.gameConfig.formattedJackpot ||
                    g(this.gameConfig.jackpot || 5555555));
            },
          },
          {
            key: "setWinMessage",
            value: function (t, e) {
              this.winText &&
                ((this.winText.textContent = t),
                (this.winText.style.color = e || "#FFD700"));
            },
          },
          {
            key: "spin",
            value: function () {
              ...
              if (this.ready) {
                if (this.money < this.bet)
                  return (
                    this.setWinMessage(
                      "💸 Out of money! Ask admin to refill.",
                      "#ff4444",
                    ),
                ...
                (this.money -= this.bet),
                  this.updateDisplay(),
                  this.spinCount++;
                var e = this.determineWin();
                if (e.win) {
                  var n = Math.floor(this.bet * e.payoutMult);
                  this.money += n;
                  var r = e.symbol;
                  (this.nextSymbols = [
                ...
                return (
                  ...
                  this.updateDisplay(),
                  d(this.currentUser, this.currentPin, this.money),
                  this.onSpinStart(),
                  Promise.all(
                          ...
                          case 0:
                            return (
                              (this.spinButton.disabled =
                                this.money < this.bet || !this.ready),
                              (t.prev = 1),
                              (t.next = 4),
                              m()
                            );
                          ...
                          case 10:
                            this.autoPlayCheckbox &&
                              ...
                              (this.money >= this.bet
                                ...
                                : (this.autoPlayCheckbox.checked = !1));
                          case 11:
                          case "end":
                            return t.stop();
                        }
